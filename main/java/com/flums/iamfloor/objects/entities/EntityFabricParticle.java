...
public class EntityFabricParticle extends ProjectileItemEntity implements IRendersAsItem {
   private LivingEntity perlThrower;
	   ...
	   public EntityFabricParticle(World worldIn, LivingEntity throwerIn) {
	      super(IAFEntities.FABRIC_PARTICLE, throwerIn, worldIn);
	      this.perlThrower = throwerIn;
	   }

	   @OnlyIn(Dist.CLIENT)
	   public EntityFabricParticle(World worldIn, double x, double y, double z) {
	      super(IAFEntities.FABRIC_PARTICLE, x, y, z, worldIn);
	   }

	   protected Item func_213885_i() {
	      return IAFItems.FABRIC_PARTICLE;
	   }
	   
	   public ItemStack getItem() {
		   ItemStack itemstack = new ItemStack(IAFItems.FABRIC_PARTICLE);
		   return itemstack;
	   }
	   ...
	   protected void onImpact(RayTraceResult result) {
	      ...
	      if (result.getType() == RayTraceResult.Type.BLOCK) {
	         BlockPos blockpos = ((net.minecraft.util.math.BlockRayTraceResult)result).getPos();
